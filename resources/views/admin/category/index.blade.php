                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Category Dashboard </h2>
                                <p class="pageheader-text">cantuman category di resto ini</p>
                                    ...
                                    <table id="example2" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                {{csrf_field()}}
                                                {{method_field('DELETE')}}        
                                                    <a href="{{url('admin/category/'.$category->id.'/edit')}}"  class="btn btn-success btn-xs">edit</a>
                                                    ...
                                                    <a href="{{url('admin/category/'.$subcategory->id.'/edit')}}" class="btn btn-success btn-xs" style="margin-top:10px; ">edit</a>
                                                    {{csrf_field()}}
                                                {{method_field('DELETE')}}        
                                                  
                                                       <input type="submit" name="" value="DELETE" class="btn btn-danger btn-xs" style="margin-top:10px; "
                                                       onclick="return confirm('yakin mau dihapus.?')">
                                                     </form>
                                                        </li>
                                                        @endforeach
